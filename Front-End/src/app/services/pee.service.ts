...
export class peeService {
    ...
    async createAtividade(atividade: any): Promise<any> {
        try {
            const response = await this.http.post(`${environment.API}/pee/createAtividade`, atividade, this.authentication.getHttpOptions())
                .toPromise()
            return response;
        } catch (error) {
            throw error;
    ...
    async updateAtividade(atividade: any): Promise<any> {
        try {
            const response = await this.http.put(`${environment.API}/pee/update/${atividade.idatividades}`, atividade, this.authentication.getHttpOptions())
                .toPromise();
            return response;
        } catch (error) {
            throw error;
    ...
    async deleteAtividade(id: number, idpee: number): Promise<any> {
        try {
            const response = await this.http.delete(`${environment.API}/pee/deleteAtividade/${id}/${idpee}`, this.authentication.getHttpOptions())
                .toPromise();
            return response;
        } catch (error) {
            throw error;
