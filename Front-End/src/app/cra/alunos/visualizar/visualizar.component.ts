...
export class VisualizarAlunoComponent implements OnInit{
  ...
  constructor(private http: HttpClient, private router: Router, public dialogQuestionService: messageDialog,
    private dialog: MatDialogRef<VisualizarAlunoComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private _adapter: DateAdapter<any>,
    @Inject(MAT_DATE_LOCALE) private _locale: string, private alunoservice: alunoService, private snackBar: MatSnackBar) { }
