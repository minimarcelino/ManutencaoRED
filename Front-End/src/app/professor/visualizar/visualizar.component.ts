...
export class VisualizarPEEComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.visualizarPee = new FormGroup({
      ...
      exigencia: new FormControl({value: this.data.exigencia, disabled: true}, [Validators.required]),
      prazo: new FormControl({value: this.data.prazo, disabled: true}, [Validators.required]),
      contato: new FormControl({value: this.data.contato, disabled: true}, [Validators.required]),
      comunicacao: new FormControl({value: this.data.comunicacao, disabled: true}),
      avaliacao: new FormControl({value: this.data.avaliacao, disabled: true}),
      avaliacaoRealizada: new FormControl({value: this.data.avaliacaoRealizada, disabled: true}),
